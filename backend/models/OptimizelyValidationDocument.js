...
const optimizelyValidationDocumentSchema = new mongoose.Schema({
  datasetId: {
...
optimizelyValidationDocumentSchema.index({ datasetId: 1, batchNumber: 1 }, { unique: true });
optimizelyValidationDocumentSchema.index({ datasetId: 1, createdAt: -1 });

module.exports = mongoose.model('OptimizelyValidationDocument', optimizelyValidationDocumentSchema);
