...
const datasetSchema = new mongoose.Schema({
  ...
  scrapingStats: {
    ...
    processedCompanies: { type: Number, default: 0 } // Companies processed so far
  },
  scrapingLastUpdate: {
    type: Date,
    default: null
  ...
  // Dynamic Yield validation tracking
  dynamicYieldValidation: {
    status: {
      type: String,
      enum: ['not_started', 'pending', 'in_progress', 'completed', 'failed'],
      default: 'not_started'
    ...
    lastResultId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'DynamicYieldValidationResult',
      default: null
    },
    summary: {
      totalUrls: { type: Number, default: 0 },
